    ...
    public class PlayFabServerAPI
    {
        ...
        public static function GetAllActionGroups(request:GetAllActionGroupsRequest, onComplete:Function, onError:Function):void
        {
            ...
            var onPostComplete:Function = function(resultData:Object, error:PlayFabError):void
            {
                ...
                {
                    var result:GetAllActionGroupsResult = new GetAllActionGroupsResult(resultData);
            ...
            PlayFabHTTP.post(PlayFabSettings.GetURL()+"/Server/GetAllActionGroups", requetJson, "X-SecretKey", PlayFabSettings.DeveloperSecretKey, onPostComplete);
        }
