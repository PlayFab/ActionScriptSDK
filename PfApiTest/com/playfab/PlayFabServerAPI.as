package com.playfab
{
    ...
    public class PlayFabServerAPI
    {
        ...
        public static function AddGuildVirtualCurrency(request:AddGuildVirtualCurrencyRequest, onComplete:Function, onError:Function):void
        {
            if (PlayFabSettings.DeveloperSecretKey == null) throw new Error ("Must have PlayFabSettings.DeveloperSecretKey set to call this method");
            var requetJson:String = JSON.stringify( request );
            ...
            var onPostComplete:Function = function(resultData:Object, error:PlayFabError):void
            {
                ...
                {
                    var result:ModifyGuildVirtualCurrencyResult = new ModifyGuildVirtualCurrencyResult(resultData);
            ...
            PlayFabHTTP.post(PlayFabSettings.GetURL()+"/Server/AddGuildVirtualCurrency", requetJson, "X-SecretKey", PlayFabSettings.DeveloperSecretKey, onPostComplete);
        }
        ...
        public static function GetGuildData(request:GetGuildDataRequest, onComplete:Function, onError:Function):void
        {
            ...
            PlayFabHTTP.post(PlayFabSettings.GetURL()+"/Server/GetGuildData", requetJson, "X-SecretKey", PlayFabSettings.DeveloperSecretKey, onPostComplete);
        }

        public static function GetGuildInternalData(request:GetGuildDataRequest, onComplete:Function, onError:Function):void
        {
            if (PlayFabSettings.DeveloperSecretKey == null) throw new Error ("Must have PlayFabSettings.DeveloperSecretKey set to call this method");
            var requetJson:String = JSON.stringify( request );
            ...
            PlayFabHTTP.post(PlayFabSettings.GetURL()+"/Server/GetGuildInternalData", requetJson, "X-SecretKey", PlayFabSettings.DeveloperSecretKey, onPostComplete);
        }
        ...
        public static function GetGuildReadOnlyData(request:GetGuildDataRequest, onComplete:Function, onError:Function):void
        {
            ...
            PlayFabHTTP.post(PlayFabSettings.GetURL()+"/Server/GetGuildReadOnlyData", requetJson, "X-SecretKey", PlayFabSettings.DeveloperSecretKey, onPostComplete);
        }
        ...
        public static function GetGuildStatistics(request:GetGuildStatisticsRequest, onComplete:Function, onError:Function):void
        {
            ...
            PlayFabHTTP.post(PlayFabSettings.GetURL()+"/Server/GetGuildStatistics", requetJson, "X-SecretKey", PlayFabSettings.DeveloperSecretKey, onPostComplete);
        }

        public static function GrantItemsToGuild(request:GrantItemsToGuildRequest, onComplete:Function, onError:Function):void
        {
            if (PlayFabSettings.DeveloperSecretKey == null) throw new Error ("Must have PlayFabSettings.DeveloperSecretKey set to call this method");
            var requetJson:String = JSON.stringify( request );
            ...
            var onPostComplete:Function = function(resultData:Object, error:PlayFabError):void
            {
                ...
                {
                    var result:GrantItemsToGuildResult = new GrantItemsToGuildResult(resultData);
            ...
            PlayFabHTTP.post(PlayFabSettings.GetURL()+"/Server/GrantItemsToGuild", requetJson, "X-SecretKey", PlayFabSettings.DeveloperSecretKey, onPostComplete);
        }

        public static function SubtractGuildVirtualCurrency(request:SubtractGuildVirtualCurrencyRequest, onComplete:Function, onError:Function):void
        {
            if (PlayFabSettings.DeveloperSecretKey == null) throw new Error ("Must have PlayFabSettings.DeveloperSecretKey set to call this method");
            var requetJson:String = JSON.stringify( request );
            ...
            PlayFabHTTP.post(PlayFabSettings.GetURL()+"/Server/SubtractGuildVirtualCurrency", requetJson, "X-SecretKey", PlayFabSettings.DeveloperSecretKey, onPostComplete);
        }
        ...
        public static function UpdateGuildData(request:UpdateGuildDataRequest, onComplete:Function, onError:Function):void
        {
            ...
            PlayFabHTTP.post(PlayFabSettings.GetURL()+"/Server/UpdateGuildData", requetJson, "X-SecretKey", PlayFabSettings.DeveloperSecretKey, onPostComplete);
        }

        public static function UpdateGuildInternalData(request:UpdateGuildDataRequest, onComplete:Function, onError:Function):void
        {
            if (PlayFabSettings.DeveloperSecretKey == null) throw new Error ("Must have PlayFabSettings.DeveloperSecretKey set to call this method");
            var requetJson:String = JSON.stringify( request );
            ...
            PlayFabHTTP.post(PlayFabSettings.GetURL()+"/Server/UpdateGuildInternalData", requetJson, "X-SecretKey", PlayFabSettings.DeveloperSecretKey, onPostComplete);
        }

        public static function UpdateGuildReadOnlyData(request:UpdateGuildDataRequest, onComplete:Function, onError:Function):void
        {
            if (PlayFabSettings.DeveloperSecretKey == null) throw new Error ("Must have PlayFabSettings.DeveloperSecretKey set to call this method");
            var requetJson:String = JSON.stringify( request );
            ...
            PlayFabHTTP.post(PlayFabSettings.GetURL()+"/Server/UpdateGuildReadOnlyData", requetJson, "X-SecretKey", PlayFabSettings.DeveloperSecretKey, onPostComplete);
        }
        ...
        public static function UpdateGuildStatistics(request:UpdateGuildStatisticsRequest, onComplete:Function, onError:Function):void
        {
            ...
            PlayFabHTTP.post(PlayFabSettings.GetURL()+"/Server/UpdateGuildStatistics", requetJson, "X-SecretKey", PlayFabSettings.DeveloperSecretKey, onPostComplete);
        }
