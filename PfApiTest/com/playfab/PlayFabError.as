package com.playfab
{
    public class PlayFabError
    {
        ...
        public static const KustoProxyQueryRateLimitExceeded:int = 1455;
        public static const EntityAPIKeyCreationDisabledForEntity:int = 1456;
        public static const StudioCreationRateLimited:int = 1457;
        public static const StudioCreationInProgress:int = 1458;
        public static const DuplicateStudioName:int = 1459;
        public static const StudioNotFound:int = 1460;
        public static const StudioDeletionInProgress:int = 1461;
        public static const StudioDeactivated:int = 1462;
        ...
        public static const TitleNotFound:int = 1466;
        public static const TitleDeletionInProgress:int = 1467;
        public static const TitleDeactivated:int = 1468;
        public static const TitleAlreadyActivated:int = 1469;
