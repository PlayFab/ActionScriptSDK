package com.playfab
{
    public class PlayFabError
    {
        ...
        public static const MatchmakingCreateTicketRequestMissing:int = 2003;
        public static const MatchmakingCreateTicketCreatorMissing:int = 2004;
        public static const MatchmakingCreateTicketCreatorIdMissing:int = 2005;
        public static const MatchmakingCreateTicketMemberListMissing:int = 2006;
        public static const MatchmakingCreateTicketGiveUpAfterInvalid:int = 2007;
        ...
        public static const MatchmakingJoinTicketPlayerMissing:int = 2015;
        ...
        public static const MatchmakingCreateTicketClientIdentityInvalid:int = 2020;
        public static const MatchmakingGetTicketPlayerMismatch:int = 2021;
        public static const MatchmakingJoinTicketServerIdentityInvalid:int = 2022;
        public static const MatchmakingJoinTicketPlayerIdentityMismatch:int = 2023;
        public static const MatchmakingCancelTicketServerIdentityInvalid:int = 2024;
        public static const MatchmakingCancelTicketPlayerIdentityMismatch:int = 2025;
        ...
        public static const MatchmakingClientTimeout:int = 2030;
        ...
        public static const MatchmakingBucketOwnerNotFound:int = 2037;
        public static const CannotEnableMultiplayerServersForTitle:int = 2038;
        public static const MatchmakingCancelAllTicketsUnauthorized:int = 2041;
        public static const MatchmakingListTicketsUnauthorized:int = 2042;
        ...
        public static const MatchmakingMatchTotalAttributeIsNegative:int = 2045;
        public static const MatchmakingAttributeTypeInvalid:int = 2046;
        public static const MatchmakingMatchTotalAttributeTooLarge:int = 2047;
        public static const MatchmakingMatchTotalAttributeSumTooLarge:int = 2048;
        public static const MatchmakingTicketUnmatchable:int = 2049;
        public static const MatchmakingCommonRegionMissing:int = 2050;
        public static const MatchmakingLatencyMeasurementMissing:int = 2051;
        public static const MatchmakingStatisticsNotFound:int = 2052;
        public static const MatchmakingPlayerHasNotJoinedTicket:int = 2053;
        public static const CannotEnablePartiesForTitle:int = 2054;
        public static const PartyError:int = 2055;
        public static const PartyRequests:int = 2056;
        public static const PartyNoContent:int = 2057;
        public static const PartyBadRequest:int = 2058;
        public static const PartyUnauthorized:int = 2059;
        public static const PartyForbidden:int = 2060;
        public static const PartyNotFound:int = 2061;
        public static const PartyConflict:int = 2062;
        public static const PartyInternalServerError:int = 2063;
        public static const PartyUnavailable:int = 2064;
        public static const PartyTooManyRequests:int = 2065;
