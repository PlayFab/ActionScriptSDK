package com.playfab
{
    ...
    public class PlayFabProfilesAPI
    {
        ...
        public static function GetTitlePlayersFromMasterPlayerAccountIds(request:GetTitlePlayersFromMasterPlayerAccountIdsRequest, onComplete:Function, onError:Function):void
        {
            if (PlayFabSettings.EntityToken == null) throw new Error("Must call GetEntityToken to call this method");
            var requetJson:String = JSON.stringify( request );
            ...
            var onPostComplete:Function = function(resultData:Object, error:PlayFabError):void
            {
                ...
                {
                    var result:GetTitlePlayersFromMasterPlayerAccountIdsResponse = new GetTitlePlayersFromMasterPlayerAccountIdsResponse(resultData);
            ...
            PlayFabHTTP.post(PlayFabSettings.GetURL("/Profile/GetTitlePlayersFromMasterPlayerAccountIds"), requetJson, "X-EntityToken", PlayFabSettings.EntityToken, onPostComplete);
        }
